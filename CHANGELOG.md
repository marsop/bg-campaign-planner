...
### Added
- **New Game Support**: Added support for *Dungeon Degenerates: Hand of Doom*.
  - Added game definitions in `games/dungeon-degenerates/game.json`.
  - Generated `cover.webp` and `background.webp` for the game.
  - Added localized data files in `translations/` for all 5 supported languages.
